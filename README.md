...
*Above: A rocket being launched from the purple planet, showing off the
particle emitter.
Below: In clock mode, the planets align to form the hands of a clock*
...
*Above: The rocket that carried Sputnik into orbit.
Below: Sputnik-1, the first artificial satellite in human history.*
